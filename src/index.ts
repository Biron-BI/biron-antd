...
export type { AnchorProps, AnchorLinkProps } from 'antd/lib/anchor';
...
export type { BreadcrumbProps, BreadcrumbItemProps } from 'antd/lib/breadcrumb';
...
export type { CollapseProps, CollapsePanelProps } from 'antd/lib/collapse';
...
export type { CheckboxProps, CheckboxOptionType } from 'antd/lib/checkbox';
...
export type { FormInstance, FormProps, FormItemProps, Rule } from 'antd/lib/form';
...
export type { MenuProps, MenuTheme, SubMenuProps, MenuItemProps } from 'antd/lib/menu';
...
export type { ModalProps, ModalFuncProps } from 'antd/lib/modal';
...
export type { RadioProps, RadioChangeEvent, RadioGroupProps } from 'antd/lib/radio';
...
export type { TableProps, TablePaginationConfig, ColumnGroupType as TableColumnGroupType, ColumnType as TableColumnType, ColumnProps as TableColumnProps, ColumnsType as TableColumnsType, } from 'antd/lib/table';
...
export type { TreeProps, AntTreeNodeProps as TreeNodeProps, DataNode as TreeDataNode, } from 'antd/lib/tree';
